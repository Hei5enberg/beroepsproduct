...
//                 // if (d.id == 1 && doEyesTurnBlue) {
//                 //     blueEyes.SetActive(true);
//                 //     StartCoroutine(turnEyesOff());
//                 // }
...
//                 Debug.Log("Title: " + d.name);
//                 Debug.Log("Option 1: " + d.option1);
//                 Debug.Log("Option 2: " + d.option2);
//                 Debug.Log("Option 3: " + d.option3);
